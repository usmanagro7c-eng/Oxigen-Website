  ...
  return (
    <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
      ...
      <div className="relative">
        ...
        <Link to="/admin/$" params={{ _splat: "orders" }} className="mt-4 w-full inline-flex items-center justify-center gap-1.5 h-9 rounded-xl bg-primary/10 hover:bg-primary/15 text-primary text-xs font-bold transition-colors">
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <Link to="/admin/$" params={{ _splat: "orders" }} className="text-xs font-semibold text-primary hover:underline inline-flex items-center gap-1 transition-colors">
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <Link to="/admin/$" params={{ _splat: "products" }} className="text-xs font-semibold text-primary hover:underline">
          View all
        </Link>
      </div>
      {products.length === 0 ? (
...
function QuickActions() {
  ...
  const actions = [
    { icon: Plus, label: "Add product", action: () => navigate({ to: "/admin/$", params: { _splat: "products" } }) },
    { icon: ShoppingCart, label: "New order", action: () => navigate({ to: "/admin/$", params: { _splat: "orders" } }) },
    { icon: Users, label: "Add customer", action: () => navigate({ to: "/admin/$", params: { _splat: "customers" } }) },
  ];
