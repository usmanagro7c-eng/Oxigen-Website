      ...
      {wishlistItems.map((p) => (
        <DashCard key={p.slug} className="group relative flex flex-col p-4">
          <button
            ...
            className="absolute right-3 top-3 z-10 grid h-10 w-10 place-items-center rounded-full bg-white/80 text-ink shadow hover:text-destructive"
          ...
          <div className="mt-auto flex items-center justify-between pt-3">
            ...
            <button
              ...
              className="touch-target inline-flex items-center gap-1.5 rounded-xl bg-gradient-to-r from-primary to-accent px-4 py-2 text-xs font-semibold text-white shadow-md shadow-primary/25 disabled:opacity-50"
            >
