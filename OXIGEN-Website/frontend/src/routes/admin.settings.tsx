...
import { Breadcrumb, Header, GlassCard, FieldGroup, Input, Select, SaveButton } from "@/components/admin/glass-form";
import { getSettings, updateSettings, uploadAdminFile, getItemImageUrl, type SettingsData } from "@/lib/admin-api";
            ...
            <GlassCard title="Security" desc="Keep your account safe.">
              <div className="space-y-4">
                <div className="flex items-center justify-between gap-4 flex-wrap">
                  ...
                  <a href="/admin/security" className="inline-flex items-center h-9 px-3.5 rounded-xl bg-card border border-border hover:bg-secondary text-xs font-semibold text-foreground transition-colors shadow-sm">Update password</a>
                </div>
