          ...
          <AnimatePresence>
            {profileOpen && (
              ...
              >
                ...
                {[
                  { icon: UserCircle, label: "Profile", to: "/admin/profile" as const },
                  { icon: Settings, label: "Settings", to: "/admin/settings" as const },
                  { icon: KeyRound, label: "API Keys", to: "/admin/api-keys" as const },
                  { icon: Shield, label: "Security", to: "/admin/security" as const },
                  { icon: Bell, label: "Notifications", to: "/admin/notifications" as const },
                ].map((i) => (
                  <Link
                    key={i.label}
                    to={i.to}
